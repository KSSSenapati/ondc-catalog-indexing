...
function ProductModal({option}) {
  ...
  const icons = {'Update': {_icon: 'fa fa-pencil', _description:"You can update details about your product here"}, 'Delete': {_icon: 'fa fa-trash', _description: 'You canr emove aa product from your catalog here.'}}
